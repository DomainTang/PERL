...
import gym
from utils.convert2base import int_to_obs
...
class PushBox(object):
    def __init__(self, H=300, grid_size=15, n_actions=4, n_agents=2, checkpoint=False): # checkpoint=False
        ...
        # each agent can choose one branch at each time_step
